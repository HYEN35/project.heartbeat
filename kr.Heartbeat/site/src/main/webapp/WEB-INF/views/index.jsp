...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/css/vendor/jquery-2.9.7-fullpage.css">
...
<body>
	<div class="inner main">
		<div class="header">
			<div class="headerWrap">
				...
				<a href="/login" class="btn-full en">Sign In</a>
			</div>
		</div>		
		<div class="scroll">
			<span></span>
		...
		<div class="container">
			...
			<div id="fullpage" class="fullpage">
				<div class="section section-intro">
					<div class="video">
						<video src="/video/newjeans.mp4" muted autoplay loop data-keepplaying playsinline></video>
					</div>
					...
					<div class="sectionWrap">
						<div class="contents">
							<div class="txtBx">
								...
								<a href="/login" class="btn-full en">Subscribe to Membership</a>
							</div>
							<div class="imgBx"></div>
						</div>
					</div>
	...
	<script src="/js/vendor/jquery-2.9.7-fullpage.min.js"></script>
