		...
		<div class="replyBx">
			...
			<div class="top">
				...
				<div class="count">
					...
					<button type="button" class="btn-i-like on" onclick="likeToggle('${UserVO.email}','${PostVO.post_id }',this);"><i class="fa-solid fa-heart"></i></button>
					</c:if>
					<c:if test="${checkLike eq 0}">
					<button type="button" class="btn-i-like" onclick="likeToggle('${UserVO.email}','${PostVO.post_id }',this);"><i class="fa-solid fa-heart"></i></button>
					</c:if>
				</div>
			</div>
			<div class="reply">
